...
<body>
    <div class="container py-5">
        <form class="w-50 m-auto" method="POST" action="update.php?id=<?= "$empId"?>">
            ...
            <div class="mb-3">
                ...
                <select class="form-select mb-3" id="country" name="country">
                    ...
                    <option value="Suadi Arabia" <?php echo ($country === 'Suadi Arabia') ? 'selected' : ''; ?>>Saudi Arabia</option>
            ...
            <div class="mb-3">
                <p>Skills</p>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="php" value="PHP" name="skills[]" <?php echo (strpos($skills, 'PHP') !== false) ? 'checked' : ''; ?>>
                    <label class="form-check-label" for="php">PHP</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="j2se" value="J2SE" name="skills[]" <?php echo (strpos($skills, 'J2SE') !== false) ? 'checked' : ''; ?>>
                    <label class="form-check-label" for="j2se">J2SE</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="mysql" value="MySQL" name="skills[]" <?php echo (strpos($skills, 'MySQL') !== false) ? 'checked' : ''; ?>>
                    <label class="form-check-label" for="mysql">MySQL</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="postgres" value="PostgreeSQL" name="skills[]" <?php echo (strpos($skills, 'PostgreeSQL') !== false) ? 'checked' : ''; ?>>
            ...
            <a class="btn btn-secondary" href="list.php" role="button">Cancel</a>
          </form>
    </div>
